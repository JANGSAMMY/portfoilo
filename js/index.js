...
const mainPage = () => {
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        function initSlider() {
            ...
            // ✅ 설명 텍스트 요소
            const descriptionElement = document.querySelector('[data-slide-description]');

            // ✅ 각 슬라이드의 설명 배열
            const slideDescriptions = [
                {
                    main: 'Teamwork & Communication',
                    sub: '협업과 효과적인 소통을 통해\n최고의 결과물을 만들어냅니다',
                },
                {
                    main: 'Proactiveness & Execution',
                    sub: '주도적으로 문제를 발견하고\n신속하게 실행하는 능력',
                },
                {
                    main: 'Core Design Mindset',
                    sub: '사용자 중심의 디자인 사고와\n창의적인 문제 해결 접근법',
                },
                {
            ...
            function updateDescription(index) {
                ...
                const description = slideDescriptions[index];
                // Fade out
                ...
                setTimeout(() => {
                    ...
                    <span class="main-text">${description.main}</span>
                    <span class="sub-text">${description.sub}</span>
                `;
            ...
            const loop = horizontalLoop(slides, {
                ...
                onChange: (element, index) => {
                    ...
                    // ✅ 실제 active 슬라이드의 인덱스 찾기
                    const activeIndex = slides.indexOf(nextSibling);
    ...
    const initTextAnimations = () => {
        document.fonts.ready.then(() => {
            ...
            gsap.set([heroText, outroText], { opacity: 1 });

            let heroSplit, outroSplit;

            if (heroText) {
                heroSplit = new SplitText(heroText, {
                    type: 'words,lines',
                    linesClass: 'line',
                    autoSplit: true,
                    mask: 'lines',
            ...
            if (outroText) {
                outroSplit = new SplitText(outroText, {
                    type: 'words,lines',
                    linesClass: 'line',
                    autoSplit: true,
                    mask: 'lines',
